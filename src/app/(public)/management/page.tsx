...
import { Shield, UserCheck, Crown, ShieldAlert, Award, Calendar, ArrowRight } from "lucide-react";
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-neutral-950 via-emerald-950/20 to-neutral-950 py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center lg:px-8">
          ...
          <p className="mt-4 text-neutral-400 max-w-2xl mx-auto">
            Honoring the leaders, managers, captains, and vice-captains who have guided and inspired FC BBFF since 2014
          </p>
        </div>
      </section>
