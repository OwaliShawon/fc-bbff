          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 mb-0.5">
                ...
                {match.homeTeam?.isExternal || match.awayTeam?.isExternal ? (
                  <span className="rounded bg-blue-500/20 border border-blue-400/40 px-1.5 py-0.5 text-[8px] font-bold text-blue-300 uppercase tracking-wide shrink-0">
                    🌐 Inter-Club
                  </span>
                ) : (
                  <span className="rounded bg-amber-500/20 border border-amber-400/40 px-1.5 py-0.5 text-[8px] font-bold text-amber-300 uppercase tracking-wide shrink-0">
                    ⚔️ Intra-Club Derby
                  </span>
                )}
              </div>
              <p className="text-[9px] sm:text-[10px] font-bold text-emerald-300 tracking-wide truncate">
        ...
        <div className="relative z-10 overflow-hidden rounded-2xl bg-white/[0.04] border-2 border-white/10 p-3.5 sm:p-5 mb-4 shadow-inner">
          ...
          <div className="relative z-10 grid grid-cols-[1fr_auto_1fr] items-center text-center gap-2">
            ...
            <div className="flex flex-col items-center min-w-0">
              <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-emerald-500/15 border-2 border-emerald-400/50 text-lg sm:text-xl font-black text-emerald-300 mb-1.5 shadow-[0_0_12px_rgba(16,185,129,0.25)] shrink-0 overflow-hidden">
              ...
              <span className="text-[9px] sm:text-[10px] text-emerald-400 font-bold mt-0.5">HOME</span>
            </div>
            ...
            {/* Away Team */}
            <div className="flex flex-col items-center min-w-0">
              <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-blue-500/15 border-2 border-blue-400/50 text-lg sm:text-xl font-black text-blue-300 mb-1.5 shadow-[0_0_12px_rgba(59,130,246,0.25)] shrink-0 overflow-hidden">
              ...
              <span className="text-[9px] sm:text-[10px] text-blue-400 font-bold mt-0.5">AWAY</span>
            </div>
          </div>
        </div>
